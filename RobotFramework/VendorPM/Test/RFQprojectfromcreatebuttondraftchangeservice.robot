...
Fill the RFQ Get Started
     ...
     GetStartedpage.Vendorlogo to create draft
...
Select Vendors
    ...
    Marketplace.Select the draft
    Sleep  5
    GetStartedpage.verify error message is correct only
    GetStartedpage.Remove the service and verify pop up and select the vendors
    GetStartedpage.verify error message is correct after service change
    ImportantDates.verify Dates are correct after change service
    ScopeofWork.Verify Line items after change service
    ScopeofWork.Land to Select Vendors
    SelectVendors.Verify page contents on scope of work
    SelectVendors.Select the Vendor
    SelectVendors.Verify progressbar link
...
Review and Submit
   ReviewandSubmit.Verify page contents on review after change service
